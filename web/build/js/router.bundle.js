...
switch (pathParams[1]) {
  ...
  case "":
    // Import the module
    __webpack_require__.e/* import() */(1).then(__webpack_require__.bind(null, 44)).then(function (module) {
  ...
  case "news":
    // Import the module
    __webpack_require__.e/* import() */(0).then(__webpack_require__.bind(null, 45)).then(function (module) {
